    ...
    <div className="navbar">
      ...
      <ul >
        <li>
          ...
          {menu === "home" ? <img src={pattern} alt="home" /> : <></>}{" "}
        </li>
        <li>
          <AnchorLink className="anchor-link" offset={50} href="#about">
            <p onClick={() => setMenu("about")}>About Me</p>
          </AnchorLink>
          {menu === "about" ? <img src={pattern} alt="home" /> : <></>}
        </li>
        <li>
          <AnchorLink className="anchor-link" offset={50} href="#achievements">
            <p onClick={() => setMenu("services")}>Achievements</p>
          </AnchorLink>
          {menu === "services" ? <img src={pattern} alt="home" /> : <></>}
        </li>
        <li>
          <AnchorLink className="anchor-link" offset={50} href="#projects">
            <p onClick={() => setMenu("portfolio")}>Projects</p>
          </AnchorLink>
          {menu === "portfolio" ? <img src={pattern} alt="home" /> : <></>}
        </li>
        <li>
          <AnchorLink className="anchor-link" offset={50} href="#contact">
            <p onClick={() => setMenu("contact")}>Contact</p>
          </AnchorLink>
          {menu === "contact" ? <img src={pattern} alt="home" /> : <></>}
        </li>
      </ul>
      <AnchorLink className="anchor-link" offset={50} href="#contact">
      ...
      <div onClick={() => setHamberger(!hamberger)} className="hamberger-icon">
        {hamberger ? (
